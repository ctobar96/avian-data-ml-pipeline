...
# ==============================================================================
# 2. Carga de Datos (Con Caché para optimizar rendimiento)
# ==============================================================================
@st.cache_data
def cargar_datos():
    # Nota: Esta ruta asume que corres el servidor desde tu máquina local.
    ...
    return pd.read_excel(file_path, sheet_name='Datos')
